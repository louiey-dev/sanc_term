...
part of 'serial_config_notifier.dart';
...
final availablePortsNotifierProvider =
    AutoDisposeNotifierProvider<AvailablePortsNotifier, List<String>>.internal(
      AvailablePortsNotifier.new,
      name: r'availablePortsNotifierProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$availablePortsNotifierHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );

typedef _$AvailablePortsNotifier = AutoDisposeNotifier<List<String>>;
